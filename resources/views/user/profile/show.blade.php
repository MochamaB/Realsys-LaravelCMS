                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="" name="status" disabled>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="profile_type_id" name="profile_type_id" disabled>
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="roles" name="roles[]" multiple disabled>

...
@section('title', 'Create Field Option')

@section('content')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Create Field Option</h4>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Create Field Option for "{{ $field->name }}"</h4>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-12">
                    ...
                    <form action="{{ route('admin.widget-types.fields.options.store', $field) }}" method="POST" class="needs-validation" novalidate>
                        @csrf

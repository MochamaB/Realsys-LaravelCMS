...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.templates.sections.update', [$template, $section]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $section->name) }}" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror" rows="3">{{ old('description', $section->description) }}</textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="width" name="width" class="form-control @error('width') is-invalid @enderror" value="{{ old('width', $section->width) }}" placeholder="e.g., col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" id="max_widgets" name="max_widgets" class="form-control @error('max_widgets') is-invalid @enderror" value="{{ old('max_widgets', $section->max_widgets) }}" min="1">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" id="order_index" name="order_index" class="form-control @error('order_index') is-invalid @enderror" value="{{ old('order_index', $section->order_index) }}" min="0">
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input type="checkbox" id="is_required" name="is_required" class="form-check-input @error('is_required') is-invalid @enderror" value="1" {{ old('is_required', $section->is_required) ? 'checked' : '' }}>
    ...
    "background": "light",
    "padding": "normal"
}'>{{ old('settings', json_encode($section->settings, JSON_PRETTY_PRINT)) }}</textarea>
                                ...
                                <div class="card mt-4">
                                    ...
                                    <div class="card-body">
                                        <p class="mb-2"><strong>Page Sections:</strong> <span class="badge bg-primary">{{ $section->pageSections()->count() }}</span></p>
                                        
                                        @if($section->pageSections()->count() > 0)
                                            <div class="alert alert-warning">
                                                <i class="mdi mdi-alert-outline me-2"></i>
                                                <small>This section is being used by {{ $section->pageSections()->count() }} page sections. Changes may affect existing pages.</small>
                                            </div>
                                        @else
                                            <div class="alert alert-success">
                                                <i class="mdi mdi-check-circle-outline me-2"></i>
                                                <small>This section is not being used by any pages yet.</small>
                                            </div>
                                        @endif
                                    </div>
                                </div>

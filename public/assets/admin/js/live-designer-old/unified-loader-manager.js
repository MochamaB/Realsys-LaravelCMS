/**
 * Unified Loader Manager - Live Designer Edition
 * 
 * Provides a single progress bar loader for all live designer operations
 * Adapted from page-builder version for live-designer context
 */
class UnifiedLoaderManager {
    constructor() {
        ...
        this.init();
        console.log('🔄 Live Designer Unified Loader Manager initialized');
    }
     ...
     */
    init() {
        // Find or create the loader container (using live designer ID)
        this.containerElement = document.getElementById('liveDesignerLoader');
        
        if (!this.containerElement) {
            console.warn('⚠️ Live designer loader container not found');
            return;
        }
        ...
        console.log('✅ Live Designer Loader elements initialized');
    }
    ...
    show(operation, message = 'Loading...', initialProgress = 0) {
        ...
        console.log(`🔄 Live Designer Loader shown for operation: ${operation} - ${message}`);
    }
    ...
    hide(operation) {
        ...
        console.log(`✅ Live Designer Loader hidden for operation: ${operation}`);
    }
    ...
    showError(operation, message = 'An error occurred') {
        ...
        console.error(`❌ Live Designer Loader error for operation: ${operation} - ${message}`);
    ...
    forceHide() {
        ...
        console.log('🔄 Live Designer Loader force hidden');
    }
...
console.log('📦 Live Designer Unified Loader Manager module loaded');